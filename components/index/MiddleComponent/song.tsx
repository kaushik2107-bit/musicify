...
export default function Song({
  ...
  // const albumLike = async () => {
  //   const docRef = doc(albumRef, songId.id);
  //   if (isLiked) {
  //     const result = await updateDoc(docRef, { likes: increment(1)})
  //   } else {
  //     const result = await updateDoc(docRef, { likes: increment(-1)})
  //   }
  // }
  ...
  return (
    <div className={saira.className}>
      <div className="h-screen overflow-scroll">
        <button
          className="m-2 mx-4 absolute p-3 px-4 rounded-full bg-gray-700 "
          ...
          <div className="h-[300px] pt-10 w-full flex items-center px-8 gap-2">
            ...
            <div className="flex-[1_1_0] min-w-0">
              <p className="truncate text-ellipsis text-[40px] text-white font-bold">
                {songId.songName || songId.albumName}
              </p>
